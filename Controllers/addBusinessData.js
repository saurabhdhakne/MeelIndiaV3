...
const databases = require("../database/models/business");
    ...
    if (err) {
      ...
      nodemailer.createTestAccount((err, account) => {
        ...
        let mailOptions = {
          ...
          <h2> <a href='${process.env.ip}/confirmEmailBusiness?enc=${randomString}'> <strong> Click Here </strong> </a> <br> to activate your account, Please do not share your password with anyone else.</h2> <br><br> 
